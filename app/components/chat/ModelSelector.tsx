                  ...
                  return (
                    <>
                      {categories.map((category) => (
                        <div key={category}>
                          {/* Category Header */}
                          <div className="px-3 py-1.5 bg-bolt-elements-background-depth-1 border-b border-bolt-elements-borderColor sticky top-0 z-10">
                            <div className="text-xs font-semibold text-bolt-elements-textSecondary uppercase tracking-wide">
                              {category}
                            </div>
                          </div>
                          {/* Models in this category */}
                          {groupedModels[category].map((modelOption) => {
                            const currentIndex = globalIndex++;
                            return (
                              <div
                                ref={(el) => (modelOptionsRef.current[currentIndex] = el)}
                                ...
                                className={classNames(
                                  ...
                                  'text-bolt-elements-textPrimary',
                                  'outline-none',
                                  model === modelOption.name || focusedModelIndex === currentIndex
                                    ? 'bg-bolt-elements-background-depth-2'
                                    : undefined,
                                  focusedModelIndex === currentIndex
                                ...
                                tabIndex={focusedModelIndex === currentIndex ? 0 : -1}
                              >
                                <div className="flex items-center justify-between">
